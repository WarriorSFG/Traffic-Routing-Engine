...
def main():
    ...
    print("=" * 70)
    print(f"Backend API listening at: http://localhost:{args.port} (Network: http://0.0.0.0:{args.port})")
    dist_dir = root_dir / "frontend" / "dist"
    if dist_dir.exists():
        print(f"Serving built React Web App at: http://localhost:{args.port}/")
    else:
